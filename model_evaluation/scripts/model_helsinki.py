...
print("####################################################")
print("Evaluation for Helsinki-NLP/opus-mt-ja-en model")
print("####################################################")
print()

###################################################################
# Evaluate Helsinki-NLP/opus-mt-ja-en model on Tatoeba samples
###################################################################
print("-----------------------------------------")
...
###################################################################
# Evaluate Helsinki-NLP/opus-mt-ja-en model on KFTT samples
###################################################################
print("-----------------------------------------")
print("KFTT samples")
print("-----------------------------------------")
...
#############################################################################################
# Evaluate Helsinki-NLP/opus-mt-ja-en model on custom Ruby programming documentation samples
#############################################################################################
print("-----------------------------------------")
...
output_file = os.path.join(output_dir, 'results_helsinki.csv')
# Save CSV
