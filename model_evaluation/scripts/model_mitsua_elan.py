...
pipe = pipeline("translation", model="Mitsua/elan-mt-bt-ja-en")
...
print("####################################################")
print("Evaluation for Mitsua/elan-mt-bt-ja-en")
print("####################################################")
print()

###################################################################
# Evaluate Mitsua/elan-mt-bt-ja-en model on Tatoeba samples
###################################################################
print("-----------------------------------------")
...
###################################################################
# Evaluate Mitsua/elan-mt-bt-ja-en model on KFTT samples
###################################################################
print("-----------------------------------------")
print("KFTT samples")
print("-----------------------------------------")
...
#############################################################################################
# Evaluate Mitsua/elan-mt-bt-ja-en model on custom Ruby programming documentation samples
#############################################################################################
print("-----------------------------------------")
...
output_file = os.path.join(output_dir, 'results_mitsua_elan.csv')
# Save CSV
