...
print("####################################################")
print("Evaluation for staka/fugumt-ja-en model")
print("####################################################")
print()

###################################################################
# Evaluate staka/fugumt-ja-en model on Tatoeba samples
###################################################################
print("-----------------------------------------")
...
###################################################################
# Evaluate staka/fugumt-ja-en model on KFTT samples
###################################################################
print("-----------------------------------------")
print("KFTT samples")
print("-----------------------------------------")
...
#############################################################################################
# Evaluate staka/fugumt-ja-en model on custom Ruby programming documentation samples
#############################################################################################
print("-----------------------------------------")
...
output_file = os.path.join(output_dir, 'results_staka_fugu.csv')
# Save CSV
